...
import ContactScript from "@/components/common/contact/ContactReservation";
...
export const metadata = {
  title: "Contact Reservation || HolidayAir",
  description: "HolidayAir Contact Reservation",
};

const ContactReservation = async ({ params: { locale } }) => {
          ...
          <div className="container">
            <div className="row y-gap-20 pt-40">
              <div className="col-auto">
                <h2>{t("contactSupport:sales-title")}</h2>
              </div>
              {/* End .col-auto */}
              <Sales />
            </div>
              ...
              <div className="col-lg-8">
                <div className="accordion -simple row y-gap-20 js-accordion">
                  <Faq
                    ...
                    translationKey={"contactSupport:sales-faq"}
                    showIcon={false}
                  />
                </div>
              </div>
...
export default dynamic(() => Promise.resolve(ContactReservation), {
  ssr: false,
});
