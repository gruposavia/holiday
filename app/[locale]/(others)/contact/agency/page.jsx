...
import ContactScript from "@/components/common/contact/ContactAgency";
...
import Agency from "@/components/contact/Agency";

export const metadata = {
  title: "Contact Agency || HolidayAir",
  description: "HolidayAir Contact Agency",
};

const ContactAgency = async ({ params: { locale } }) => {
          ...
          <div className="container">
            <div className="row y-gap-20 pt-40">
              <div className="col-auto">
                <h2>{t("contactSupport:agency-title")}</h2>
              </div>
              {/* End .col-auto */}
              <Agency />
            </div>
              ...
              <div className="col-lg-8">
                <div className="accordion -simple row y-gap-20 js-accordion">
                  <Faq
                    ...
                    translationKey={"contactSupport:agency-faq"}
                    showIcon={false}
                  />
                </div>
              </div>
...
export default dynamic(() => Promise.resolve(ContactAgency), { ssr: false });
